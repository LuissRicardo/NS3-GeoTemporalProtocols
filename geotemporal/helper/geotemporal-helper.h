...
#ifndef GEOTEMPORAL_HELPER_H
#define GEOTEMPORAL_HELPER_H
 ...
 * \ingroup geotemporal
 * 
 * \brief Helper class that adds Geo-Temporal routing to nodes.
 */
class GeoTemporalHelper : public Ipv4RoutingHelper
{
private:
...
public:
  ...
  /**
   * Create a GeoTemporalHelper that makes life easier for people 
   * who want to install Geo-Temporal routing protocol to nodes.
   */
  GeoTemporalHelper ();

  /**
   * Constructs an GeoTemporalHelper instance from another previously 
   * initialized instance (AKA copy constructor).
   * @param copy Instance to copy.
   */
  GeoTemporalHelper (const GeoTemporalHelper & copy);

  /**
   * This method is mainly for internal use by the other helpers;
   * clients are expected to free the dynamic memory allocated by this method.
   * 
   * @return pointer to clone of this GeoTemporalHelper
   */
  GeoTemporalHelper* Copy (void) const override;
  ...
  /**
   * This method controls the attributes of ns3::geotemporal::RoutingProtocol.
   ...
   * Geo-Temporal routing protocol should be modified to use a fixed stream.
...
private:
   ...
   * @return nothing
   */
  GeoTemporalHelper& operator= (const GeoTemporalHelper& rhs);
};

} // namespace ns3

#endif /* GEOTEMPORAL_HELPER_H */
