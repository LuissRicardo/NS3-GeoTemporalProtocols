...
#ifndef GEOTEMPORAL_SPRAY_AND_WAIT_HELPER_H
#define GEOTEMPORAL_SPRAY_AND_WAIT_HELPER_H
 ...
 * 
 * \brief Helper class that adds Geo-Temporal Spray & Wait routing to nodes.
 */
class GeoTemporalSprayAndWaitHelper : public Ipv4RoutingHelper
{
private:
...
public:
  ...
  /**
   * Constructs an SprayAndWaitHelper instance from another previously 
   * initialized instance (AKA copy constructor).
   * @param copy Instance to copy.
   */
  GeoTemporalSprayAndWaitHelper (const GeoTemporalSprayAndWaitHelper & copy);

  /**
   * This method is mainly for internal use by the other helpers;
   * clients are expected to free the dynamic memory allocated by this method.
   * 
   * @return pointer to clone of this GeoTemporalSprayAndWaitHelper
   */
  GeoTemporalSprayAndWaitHelper* Copy (void) const override;
  ...
  /**
   * This method controls the attributes of ns3::geotemporal_spray_and_wait::RoutingProtocol.
...
private:
   ...
   * @return nothing
   */
  GeoTemporalSprayAndWaitHelper& operator= (const GeoTemporalSprayAndWaitHelper& rhs);
};

} // namespace ns3

#endif /* GEOTEMPORAL_SPRAY_AND_WAIT_HELPER_H */
