...
#ifndef GEOTEMPORAL_SPRAY_AND_WAIT_APPLICATION_H
#define GEOTEMPORAL_SPRAY_AND_WAIT_APPLICATION_H
 ...
 * 
 * Application for the Geo-Temporal Spray And Wait protocol. It is associated 
 ...
 * Geo-Temporal Spray And Wait messages.
 */
class GeoTemporalSprayAndWaitApplication : public Application
{
private:
...
public:
  ...
  GeoTemporalSprayAndWaitApplication ();
  GeoTemporalSprayAndWaitApplication (const GeoTemporalSprayAndWaitApplication & copy);

  virtual ~GeoTemporalSprayAndWaitApplication ();
...
#endif /* GEOTEMPORAL_SPRAY_AND_WAIT_APPLICATION_H */
