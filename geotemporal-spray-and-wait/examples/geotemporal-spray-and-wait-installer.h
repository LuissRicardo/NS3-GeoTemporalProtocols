...
#ifndef GEOTEMPORAL_SPRAY_AND_WAIT_INSTALLER_H
#define GEOTEMPORAL_SPRAY_AND_WAIT_INSTALLER_H
...
class GeoTemporalSprayAndWaitInstaller
{
private:
...
public:
  ...
  GeoTemporalSprayAndWaitInstaller (const GeoTemporalSprayAndWaitInstaller & copy);
...
#endif /* GEOTEMPORAL_SPRAY_AND_WAIT_INSTALLER_H */
