 ...
 * 
 * Neighbors table of the Geo-Temporal Spray And Wait protocol.
 */

#ifndef GEOTEMPORAL_SPRAY_AND_WAIT_NEIGHBOR_TABLE_H
#define GEOTEMPORAL_SPRAY_AND_WAIT_NEIGHBOR_TABLE_H
 ...
 * 
 * Entry of the neighbors table of the Geo-Temporal Spray And Wait protocol.
 */
class NeighborEntry
{
private:
...
#endif /* GEOTEMPORAL_SPRAY_AND_WAIT_NEIGHBOR_TABLE_H */
