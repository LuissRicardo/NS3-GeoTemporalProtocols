...
#ifndef GEOTEMPORAL_EPIDEMIC_APPLICATION_H
#define GEOTEMPORAL_EPIDEMIC_APPLICATION_H
 ...
 * 
 * Application for the Geo-Temporal Epidemic protocol. It is associated 
 ...
 * Geo-Temporal Epidemic messages.
 */
class GeoTemporalEpidemicApplication : public Application
{
private:
...
public:
  ...
  GeoTemporalEpidemicApplication ();
  GeoTemporalEpidemicApplication (const GeoTemporalEpidemicApplication & copy);

  virtual ~GeoTemporalEpidemicApplication ();
...
#endif /* GEOTEMPORAL_EPIDEMIC_APPLICATION_H */
