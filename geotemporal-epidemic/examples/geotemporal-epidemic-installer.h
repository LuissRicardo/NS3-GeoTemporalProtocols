...
#ifndef GEOTEMPORAL_EPIDEMIC_INSTALLER_H
#define GEOTEMPORAL_EPIDEMIC_INSTALLER_H
...
class GeoTemporalEpidemicInstaller
{
private:
...
public:
  ...
  GeoTemporalEpidemicInstaller (const GeoTemporalEpidemicInstaller & copy);
...
#endif /* GEOTEMPORAL_EPIDEMIC_INSTALLER_H */
