 ...
 * \brief Geo-Temporal Epidemic protocol packet types.
 * 
 * Contains all the possible types of packets in the Geo-Temporal Epidemic
 * protocol:
 * 
 ...
 * \ingroup geotemporal-epidemic
 * 
 * Header that contains the type of the Geo-Temporal Epidemic protocol 
 * packets.
 */
...
#endif /* GEOTEMPORAL_EPIDEMIC_PACKETS_H */
