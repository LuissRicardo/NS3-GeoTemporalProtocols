 ...
 * 
 * Geo-Temporal Epidemic protocol packets.
 */
...
{
  static TypeId type_id = TypeId ("ns3::geotemporal_epidemic::TypeHeader")
          .SetParent<Header> ()
...
TypeHeader::ToString () const
{
  ...
  return geotemporal_epidemic::ToString (m_packet_type);
}
...
{
  static TypeId type_id = TypeId ("ns3::geotemporal_epidemic::HelloHeader")
          .SetParent<Header> ()
          .SetGroupName ("Geotemporal-epidemic")
...
{
  static TypeId type_id = TypeId ("ns3::geotemporal_epidemic::SummaryVectorHeader")
          .SetParent<Header> ()
          .SetGroupName ("Geotemporal-epidemic")
...
{
  static TypeId type_id = TypeId ("ns3::geotemporal_epidemic::DataHeader")
          .SetParent<Header> ()
          .SetGroupName ("Geotemporal-epidemic")
...
DataHeader::ToString () const
{
  ...
  std::string str = "DATA " + m_data_id.ToString () + " (" + std::string (buffer)
          + " hops left) destined to area " + m_dest_geo_temporal_area.GetArea ().ToString ();
