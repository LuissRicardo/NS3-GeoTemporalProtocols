...
#ifndef GEOTEMPORAL_EPIDEMIC_HELPER_H
#define GEOTEMPORAL_EPIDEMIC_HELPER_H
 ...
 * 
 * \brief Helper class that adds Geo-Temporal Epidemic routing to nodes.
 */
class GeoTemporalEpidemicHelper : public Ipv4RoutingHelper
{
private:
...
public:
  ...
  /**
   * Create an GeoTemporalEpidemicHelper that makes life easier for people who 
   * want to install Epidemic routing protocol to nodes.
   */
  GeoTemporalEpidemicHelper ();

  /**
   * Constructs a GeoTemporalEpidemicHelper instance from another previously 
   * initialized instance (AKA copy constructor).
   * @param copy Instance to copy.
   */
  GeoTemporalEpidemicHelper (const GeoTemporalEpidemicHelper & copy);

  /**
   * This method is mainly for internal use by the other helpers;
   * clients are expected to free the dynamic memory allocated by this method.
   * 
   * @return pointer to clone of this GeoTemporalEpidemicHelper
   */
  GeoTemporalEpidemicHelper* Copy (void) const override;
  ...
  /**
   * This method controls the attributes of ns3::geotemporal_epidemic::RoutingProtocol.
...
private:
   ...
   * @return nothing
   */
  GeoTemporalEpidemicHelper& operator= (const GeoTemporalEpidemicHelper& rhs);
};

} // namespace ns3

#endif /* GEOTEMPORAL_EPIDEMIC_HELPER_H */
