...
#include <ns3/geotemporal-epidemic-module.h>
...
public:
  ...
  {
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator== (equal_1, equal_1), true, "Must be equal");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator== (equal_1, equal_2), true, "Must be equal");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator== (equal_1, different), false, "Must not be equal");

    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator!= (equal_1, equal_1), false, "Must not be different");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator!= (equal_1, equal_2), false, "Must not be different");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator!= (equal_1, different), true, "Must be different");

    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator== (equal_2, equal_1), true, "Must be equal");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator== (equal_2, equal_2), true, "Must be equal");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator== (equal_2, different), false, "Must not be equal");

    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator!= (equal_2, equal_1), false, "Must not be different");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator!= (equal_2, equal_2), false, "Must not be different");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator!= (equal_2, different), true, "Must be different");

    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator== (different, equal_1), false, "Must not be equal");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator== (different, equal_2), false, "Must not be equal");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator== (different, different), true, "Must be equal");

    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator!= (different, equal_1), true, "Must be different");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator!= (different, equal_2), true, "Must be different");
    NS_TEST_EXPECT_MSG_EQ (ns3::geotemporal_epidemic::operator!= (different, different), false, "Must not be different");
  }
};
 ...
 * 
 * \ingroup tests
 * \ingroup geotemporal-epidemic-test
 */
...
public:
  ...
  TestConstructors ()
  {
    ...
    DataHeader h2 (data_id, gta, message, hops);
  ...
  TestGettersSetters ()
  {
    ...
    DataHeader header (data_id, gta, message, hops);
  ...
  TestOverloadedOperators ()
  {
    ...
    DataHeader equal_1 (data_id, gta, message, hops);
    DataHeader equal_2 (data_id, gta, message, hops);
    DataHeader different (DataIdentifier (Ipv4Address ("1.2.3.4"), 99u), gta, message, hops);
    ...
    different = DataHeader (data_id, gta, "Different message", hops);
  ...
  TestToString ()
  {
    ...
    DataHeader h (data_id, gta, message, hops);
    std::string expected_str = "DATA 1.2.3.4:5 (5 hops left) destined to area "
...
public:
  ...
  m_hops_count (15u),
  m_header (m_data_id, m_geo_temporal_area, m_message, m_hops_count),
  m_queue_entry () { }
...
// =============================================================================
//                          GeoTemporalEpidemicTestSuite
// =============================================================================

/**
 * Geo-Temporal Epidemic test suite.
 * 
 * \ingroup tests
 * \ingroup geotemporal-epidemic-test
 */
class GeoTemporalEpidemicTestSuite : public TestSuite
{
public:

  GeoTemporalEpidemicTestSuite () : TestSuite ("geotemporal-epidemic", UNIT)
  {
...
static GeoTemporalEpidemicTestSuite g_geotemporal_epidemic_test_suite;
