...
#ifndef GEOTEMPORAL_RESTRICTED_EPIDEMIC_INSTALLER_H
#define GEOTEMPORAL_RESTRICTED_EPIDEMIC_INSTALLER_H
...
class GeoTemporalRestrictedEpidemicInstaller
{
private:
  ...
  /**
   * The number of hops that each DATA packet is allowed to travel before being
   * discarded.
   */
  uint32_t m_data_packet_hops_count;
...
public:
  ...
  GeoTemporalRestrictedEpidemicInstaller (const GeoTemporalRestrictedEpidemicInstaller & copy);
...
#endif /* GEOTEMPORAL_RESTRICTED_EPIDEMIC_INSTALLER_H */
